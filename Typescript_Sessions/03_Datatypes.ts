...
let num1:number=42; // integer
let num2:number=3.14; // floating point 
let num3:number=0xFF; // hexadecimal
let num4:number=0o77; // octal
let num5:number=0b1010; // binary
...
let str3:string=`This is a template string with ${str1}`;
console.log(str1,str2,str3);

let srtvar:string=str1+str2;
console.log(srtvar);
...
let num7:number|undefined=undefined;
